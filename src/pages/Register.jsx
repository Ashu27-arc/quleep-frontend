...
import { Box, User, Mail, Lock, UserPlus, Loader2, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-xs text-neutral-400 mt-1 uppercase tracking-widest font-semibold">Join today and build your 3D gallery</p>
        </div>
        ...
        <div className="bg-neutral-900/40 border border-neutral-900 rounded-3xl p-6 sm:p-8 backdrop-blur-md shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Name Field */}
            <div>
              <label htmlFor="name" className="block text-[10px] font-bold text-neutral-500 uppercase tracking-widest mb-1.5 ml-1">
                Full Name
              </label>
            ...
            {/* Password Field */}
            <div>
              <label htmlFor="password" className="block text-[10px] font-bold text-neutral-500 uppercase tracking-widest mb-1.5 ml-1">
                Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-neutral-500">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-[10px] font-bold text-neutral-500 uppercase tracking-widest mb-1.5 ml-1">
                Confirm Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-neutral-500">
